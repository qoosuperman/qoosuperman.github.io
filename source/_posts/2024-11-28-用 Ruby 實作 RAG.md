...
我第一次接觸到 RAG 是在 [Hello World Dev Conference](https://hwdc.ithome.com.tw/2024) 的 workshop 中。雖然 workshop 只是簡單地帶我們實作從一個 PDF 檔案中搜尋內容，但這次體驗讓我了解到目前市場上常見解決方案背後的原理。為了進一步了解 RAG 的運作方式，我決定自己實作一個。
...
在 UI 實作方面，，我使用 Rails 搭配 [Turbo](https://turbo.hotwired.dev/) 來作出簡單的問答頁面
